...
hiw_NP$NO_FUNC_WORDS = hiw_NP$NO_FUNC_WORDS_MONO + hiw_NP$NO_FUNC_WORDS_MULTI
summary(hiw_NP)

# Get the correlations
hiw_NP_corr = subset(hiw_NP, !is.na(EDUC_STEP), select = c(NO_WORDS, NO_SYLLS, NO_PHON_WORDS, NO_FUNC_WORDS, NO_FUNC_WORDS_MONO, NO_FUNC_WORDS_MULTI, SPEAKING_RATE, DOB, EDUC_STEP))
...
hiw_NP_corr$NO_PHON_WORDS = log(hiw_NP_corr$NO_PHON_WORDS)
hiw_NP_corr$NO_FUNC_WORDS = log(hiw_NP_corr$NO_FUNC_WORDS + 1)
hiw_NP_corr$NO_FUNC_WORDS_MONO = log(hiw_NP_corr$NO_FUNC_WORDS_MONO + 1)
hiw_NP_corr$NO_FUNC_WORDS_MULTI = log(hiw_NP_corr$NO_FUNC_WORDS_MULTI + 1)
cor(hiw_NP_corr)
...
hiw_NP_NO_PHON_WORDS.lme = lmer(NEWTWO ~ log(NO_PHON_WORDS) + SPEAKING_RATE + DOB + CORPUS + SEX + EDUC_STEP + WORD + CV + PREC_STRESS + (1 | PREC_WORD) + (1 | FOLL_WORD) + (1 | DIALECT) + (1 | SPEAKER), hiw_NP, family = 'binomial')
...
hiw_NP_NO_FUNC_WORDS_MONO.lme = lmer(NEWTWO ~ log(NO_FUNC_WORDS_MONO + 1) + SPEAKING_RATE + DOB + CORPUS + SEX + EDUC_STEP + WORD + CV + PREC_STRESS + (1 | PREC_WORD) + (1 | FOLL_WORD) + (1 | DIALECT) + (1 | SPEAKER), hiw_NP, family = 'binomial')
summary(hiw_NP_NO_FUNC_WORDS_MONO.lme)
...
NO_PHON_WORDS_rwords = lm(log(NO_PHON_WORDS) ~ log(NO_WORDS), hiw_NP)$resid
...
hiw_NP_NO_WORDS_FUNC_MULTI.lme = lmer(NEWTWO ~ log(NO_WORDS) + log(NO_FUNC_WORDS_MULTI + 1) + DOB + CORPUS + SEX + EDUC_STEP + WORD + CV + PREC_STRESS + (1 | PREC_WORD) + (1 | FOLL_WORD) + (1 | DIALECT) + (1 | SPEAKER), hiw_NP, family = 'binomial')
summary(hiw_NP_NO_WORDS_FUNC_MULTI.lme)
...
# Phon words
NO_WORDS_rphon = lm(log(NO_WORDS) ~ log(NO_PHON_WORDS), hiw_NP)$resid
hiw_NP_NO_PHON_WORDS.lme = lmer(NEWTWO ~ log(NO_PHON_WORDS) + NO_WORDS_rphon + DOB + CORPUS + SEX + EDUC_STEP + WORD + CV + PREC_STRESS + (1 | PREC_WORD) + (1 | FOLL_WORD) + (1 | DIALECT) + (1 | SPEAKER), hiw_NP, family = 'binomial')
summary(hiw_NP_NO_PHON_WORDS.lme)
# Func words
...
summary(hiw_NP_NO_FUNC_WORDS.lme)
hiw_NP_NO_FUNC_WORDS.lme = lmer(NEWTWO ~ log(NO_FUNC_WORDS + 1) + log(NO_FUNC_WORDS_MULTI + 1) + NO_WORDS_rfunc + DOB + CORPUS + SEX + EDUC_STEP + WORD + CV + PREC_STRESS + (1 | PREC_WORD) + (1 | FOLL_WORD) + (1 | DIALECT) + (1 | SPEAKER), hiw_NP, family = 'binomial')
summary(hiw_NP_NO_FUNC_WORDS.lme)

# Func and phon together
NO_WORDS_FUNC_rphon = lm(log(NO_FUNC_WORDS + 1) ~ log(NO_PHON_WORDS), hiw_NP)$resid
hiw_NP_NO_PHON_FUNC.lme = lmer(NEWTWO ~ log(NO_PHON_WORDS) + NO_WORDS_FUNC_rphon + SPEAKING_RATE + DOB + CORPUS + SEX + EDUC_STEP + WORD + CV + PREC_STRESS + (1 | PREC_WORD) + (1 | FOLL_WORD) + (1 | DIALECT) + (1 | SPEAKER), hiw_NP, family = 'binomial')
summary(hiw_NP_NO_PHON_FUNC.lme)
# Reverse order to see coefficient
NO_PHON_WORD_rfunc = lm(log(NO_PHON_WORDS) ~ log(NO_FUNC_WORDS + 1), hiw_NP)$resid
...
hiw_NP_DEPTH.lme = lmer(NEWTWO ~ SUBJ_DEPTH + SPEAKING_RATE + DOB + SEX + EDUC_STEP + WORD + CV + PREC_STRESS + (1 | PREC_WORD) + (1 | FOLL_WORD) + (1 | DIALECT) + (1 | SPEAKER), hiw_NP_parsed, family = 'binomial')
summary(hiw_NP_DEPTH.lme)
DEPTH_rphon = lm(SUBJ_DEPTH ~ log(NO_PHON_WORDS), hiw_NP_parsed)$resid
hiw_NP_DEPTH_NO_PHON_WORDS.lme = lmer(NEWTWO ~ log(NO_PHON_WORDS) + DEPTH_rphon + SPEAKING_RATE + DOB + SEX + EDUC_STEP + WORD + CV + PREC_STRESS + (1 | PREC_WORD) + (1 | FOLL_WORD) + (1 | DIALECT) + (1 | SPEAKER), hiw_NP_parsed, family = 'binomial')
summary(hiw_NP_DEPTH_NO_PHON_WORDS.lme)
# Throw in some syllables, for a challenge, still significant
NO_SYLLS_rphon = lm(log(NO_SYLLS) ~ log(NO_PHON_WORDS), hiw_NP)$resid
hiw_NP_NO_PHON_SYLL.lme = lmer(NEWTWO ~ log(NO_PHON_WORDS) + NO_SYLLS_rphon + SPEAKING_RATE + DOB + CORPUS + SEX + EDUC_STEP + WORD + CV + PREC_STRESS + (1 | PREC_WORD) + (1 | FOLL_WORD) + (1 | DIALECT) + (1 | SPEAKER), hiw_NP, family = 'binomial')
summary(hiw_NP_NO_PHON_SYLL.lme)
# TODO: Try with number of right brackets

# Pile on orth. words for extra challenge
NO_WORDS_rphonsylls = lm(log(NO_WORDS) ~ log(NO_PHON_WORDS) + NO_SYLLS_rphon, hiw_NP)$resid
hiw_NP_NO_PHON_SYLL_WORDS.lme = lmer(NEWTWO ~ log(NO_PHON_WORDS) + NO_SYLLS_rphon + NO_WORDS_rphonsylls + SPEAKING_RATE + DOB + CORPUS + SEX + EDUC_STEP + WORD + CV + PREC_STRESS + (1 | PREC_WORD) + (1 | FOLL_WORD) + (1 | DIALECT) + (1 | SPEAKER), hiw_NP, family = 'binomial')
